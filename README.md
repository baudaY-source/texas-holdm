...
> 高清牌面、九名 AI 肖像、1,244,484 手 HU NFSP 轻量权重、图表与启用策略；
...
- **人设 AI**:公牛/狐狸/犀牛/屠夫猪/看门狗/流浪猫/渡鸦/兔子/灰狼
  九名身份，单桌最多八名 AI；身份可搭配 TAG、LAG、岩石、跟注站、均衡、
...
冒烟:exe 以 `--headless-screenshot` 无显示渲染全部 18 张界面截图,
...
ai/         九身份/八打法/对白/启发式机器人、最佳牌型分析、HU NFSP 轻量运行时与安全路由、竞技场
gto/        翻前图表、策略库与可选求解器桥
training/   训练场场景、快速分析、drills 引擎、回顾/统计纯逻辑
ui/         主题/控件/牌面/角色/特效、买入设置及牌桌/图表/训练/drills/回顾/统计场景
assets/     高清牌面、九张动物酒馆肖像、版本化 NFSP 轻量推理权重
