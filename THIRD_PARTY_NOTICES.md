...
| 组件 | 用途 | 许可证 / 来源 |
| --- | --- | --- |
| TexasSolver v0.2.0 | 可选 HU 离线求解器，以未修改 Windows 二进制子进程调用；本部署源码不携带二进制 | AGPL-3.0；<https://github.com/bupticybee/TexasSolver>；另见 `third_party/texassolver/SOURCE.md` |
