...
if exist "%TAVERN_CLOUDFLARED%" (
  "%TAVERN_PYTHON%" "%~dp0run_friends_alpha.py" --public-quick-tunnel --phone-verifies-public --launch-desktop-host --cloudflared "%TAVERN_CLOUDFLARED%" %*
) else (
  "%TAVERN_PYTHON%" "%~dp0run_friends_alpha.py" --public-quick-tunnel --phone-verifies-public --launch-desktop-host %*
)
